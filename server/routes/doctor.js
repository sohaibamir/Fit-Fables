...
const { createDoctor, getAllDoctors, getDoctorById, deleteDoctor, updateDoctor, bookAppointment, getRemainingAppointments, getCompletedAppointments } = require('../controllers/doctor');
